...
- [ ] Add a pre-commit hook for linters/formatters. This will force devs to mainitain code quality before merging code. .vscode/settings.json references some linters we can use
